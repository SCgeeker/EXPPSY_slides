...
```{r myographion, fig.align='center',  fig.cap="赫爾曼．海姆赫茲製作的肌動描記儀，出自 Cyon, Elie de.(1876)", paged.print=TRUE}
...
- 檢視 @zwaanParticipantNonnaiveteReproducibility2017 再現的[三項知覺實驗](https://osf.io/5hxge/)，與原始研究的假設及方法的差異。
  - @craftProcessingSymbolicInformation1970 的[Simon task](https://osf.io/jt2k3/)
  - @eriksenEffectsNoiseLetters1974 的[Flanker task](https://osf.io/v4xtp/)。
  - @eimerEffectsMaskedStimuli1998 的[Motor Priming](https://osf.io/9y7ak/)
